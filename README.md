...
The redesigned application is available on `redesign/guest-first-experience`, proposed in [PR #1](https://github.com/chunks-labs/LumenPoly/pull/1). To run that version:

```sh
git clone --branch redesign/guest-first-experience https://github.com/chunks-labs/LumenPoly.git
cd LumenPoly

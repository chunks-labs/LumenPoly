...
export const lumenPolyBoard: BoardTile[] = [
  {
    ...
    name: 'Launch',
    type: 'corner',
    description: 'Collect 200 simulated XLM when you pass or land here.',
  },
  ...
  { id: 3, name: 'Freighter Wallet', type: 'property', price: 60, rent: 4, color: 'brown' },
  {
    ...
    type: 'tax',
    description:
      'Pay a 200 simulated XLM game fee. This is a board-game rule, not an actual Stellar fee.',
  },
  ...
  { id: 9, name: 'Stellar DEX', type: 'property', price: 120, rent: 8, color: 'lightblue' },
  {
    ...
    name: 'Waiting Room',
    type: 'corner',
    description: 'Just visiting is free. If sent here, miss one roll before rejoining the game.',
  },
  ...
  { id: 19, name: 'Decentralized Oracle', type: 'property', price: 200, rent: 16, color: 'orange' },
  {
    ...
    name: 'Rest Stop',
    type: 'corner',
    description: 'Take a breather. No fee and no bonus on this space.',
  },
  ...
  { id: 29, name: 'DAO Treasury', type: 'property', price: 280, rent: 24, color: 'yellow' },
  {
    ...
    type: 'corner',
    description:
      'Move directly to the Waiting Room. Miss one roll; do not collect a Launch reward for this move.',
  },
